"""Dataset utilities for loading imagery, optional topography chips, and tabular covariates."""
...
class HostNAIPDataset(Dataset):
    """PyTorch dataset for SDM training/evaluation with optional topo chips."""
